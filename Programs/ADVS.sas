...
/*Set to 'Y' for the record which is latest before treatment or latest record from VS.VSTPT = 'PREOPERATIVE'*/
...
DATA VS5;
   ...
   /*CRIT1 AND CRIT2 SHOULD BE DERIVED AS SINGLE VARIABLE IN GENERAL*/
