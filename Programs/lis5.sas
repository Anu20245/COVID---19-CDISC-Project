...
DATA ADLB;
   ...
   IF /* Biochemistry */ PARCAT1='CHEMISTRY' and /* Abnormal */ ANRIND not in ('NORMAL','');
/*   convert numeric date to character*/
   ADTC= PUT (ADT,YYMMDD10.);
/*   second last column - Result*/
   AVAL_C= STRIP (PUT (AVAL,BEST.));
/*   column three - Normal Range*/
...
footnote1 j=l 'C:\C1\ST\Jul2022\CL\program\LIS5.SAS';


options orientation=landscape;
ods escapechar='^';
ods rtf file='C:\C1\ST\Jul2022\CL\OUTPUTS\l_16_2_1_5.rtf' style=styles.test;
