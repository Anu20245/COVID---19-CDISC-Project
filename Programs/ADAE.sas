...
DATA AE4;
   ...
   ELSE IF AEACN  IN ('DISCONTINUED' 'DRUG WITHDRAWN') THEN DO;AACN='Discontinued';AACNN=3;END;
...
/**/
/*If day is missing and month and year are available in AE.AESTDTC then set day value os ""01"";*/
/**/
/*For Missing time value:*/
/**/
/*If date in AE.AESTDTC is not missing and time in AE.AESTDTC is missing and AE.AESTDTC equals to ADSL.TRTSDT*/
/*then set to timepart of ADSL.TRTSDTM +1;*/
/*If date in AE.AESTDTC is not missing and time in AE.AESTDTC is missing and AE.AESTDTC not equals to ADSL.TRTSDT */
/*then set to ""00:01"";"*/
/**/
/*ASTDT*/
/**/
...
/*For Missing Date values:*/
/**/
/*If day is missing and month and year are available in AE.CMEnDTC then set to last day value of the month;*/
/**/
/*For Missing time value:*/
/**/
/*If date in AE.AEENDTC is not missing and time in AE.AEENDTC is missing and AE.AEENDTC  */
