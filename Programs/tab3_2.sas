...
* Program Type: Table
*
* Purpose: To produce Table 14.1.4  Subject Demographics - Age (ITT Population)
* Usage Notes: 
*
* SAS Version: 9.4
...
title3 j=c 'Table 14.1.4  Subject Demographics - Age (ITT Population)';

footnote1 j=l 'C:\C1\ST\Jul2022\CL\program\tab3_2.SAS';


options orientation=landscape;
ods escapechar='^';
ods rtf file='C:\C1\ST\Jul2022\CL\OUTPUTS\t_14_1_4.rtf' style=styles.test;
