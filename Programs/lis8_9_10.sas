...
%macro ae (v1=,v2=,v3=,v4=);
   ...
   %if &NBR gt 0 %then %do;
/*   if data set have obervations then produce report per mock shell*/
      DATA ADAE;
         SET ADAE;
      ...
      footnote1 j=l "C:\C1\ST\Jul2022\CL\program\&v3.SAS";


      options orientation=landscape;
      ods escapechar='^';
      ods rtf file="C:\C1\ST\Jul2022\CL\OUTPUTS\&v4..rtf" style=styles.test;

      proc report data=adae split='|'
   ...
   %if &nbr eq 0 %then %do;
/*   if input data set is empty then produce NO OBS report*/
      DATA ADAE;
         usubjid='';
...
%ae (v1=%str (AESER EQ 'Y' AND AEOUT EQ 'FATAL'),
